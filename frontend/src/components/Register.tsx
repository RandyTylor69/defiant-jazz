...
export default function Register({
  ...
  return (
    ...
    >
      <h2
        className="absolute top-2 right-2 text-black/40 cursor-pointer"
      ...
      {/** ------- option 1 --------- */}
      <button
        className="btn-primary w-[70%] !bg-black/70 !border-none !text-sm"
      ...
      {/** ------- option 2 --------- */}
      <form
        onSubmit={(e) => register(e, email, password, navigate)}
